...
You are a puzzle maker designin geometric, physical, and topological
...
def _create_progam_execution_string(program: Program) -> str:
    ...
    for i, ((input_, expected), evaluation) in enumerate(
        ...
        evaluation_results.append(
            f"{'Correct' if correct else 'Wrong'} Execution {i+1}\n{execution_str}"
        )
...
Iterate on previuos Python functions `transform` so that there will be more correct executions.
"""
