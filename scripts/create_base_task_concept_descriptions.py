...
def generate_puzzle_description(concept: Concept):
...
with open("./data/base_task_descriptions.csv", mode="w", newline="") as file:
    writer = csv.writer(file)
    # Write the header
    writer.writerow(["concept", "description"])

    # Loop through each concept and write to the CSV
    for concept in Concept:
        writer.writerow([concept.value, generate_puzzle_description(concept)])
